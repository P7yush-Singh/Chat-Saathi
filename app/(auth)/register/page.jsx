...
import { apiRequest } from "@/lib/apiClient"; // your helper - unchanged
    ...
    <div className="min-h-[calc(100vh-64px)] bg-[#0b141a] flex flex-col items-center px-4 py-10">
        ...
        {step === "form" && (
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-1">
                  <span className="px-2 py-2 rounded-md bg-[#070f17] border border-[#1f2933] text-slate-400 text-xs">
                    @
                  </span>
                  <input
                    className="w-full px-3 py-2 rounded-md bg-[#070f17] border border-[#1f2933] text-slate-100 outline-none focus:border-emerald-500"
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 w-full py-2.5 rounded-md bg-emerald-500 text-black font-semibold text-sm hover:bg-emerald-400 disabled:opacity-60"
            >
        ...
        {step === "otp" && (
          ...
          >
            ...
            <button
              type="submit"
              disabled={otpLoading}
              className="w-full py-2.5 rounded-md bg-emerald-500 text-black font-semibold text-sm hover:bg-emerald-400 disabled:opacity-60"
            >
            ...
            <button
              ...
              className="w-full py-2.5 rounded-md border border-[#1f2933] text-slate-200 text-sm hover:bg-[#070f17] disabled:opacity-60"
            >
              Resend code
            </button>
      ...
      <div className="w-full max-w-4xl mt-6 bg-[#111b21] border border-[#202c33] rounded-2xl px-6 md:px-10 py-5 text-xs md:text-sm text-slate-300">
        ...
        <ul className="list-disc list-inside space-y-1 text-slate-400">
          ...
          <li>
            Email is private, only your name & username are public.
          </li>
        </ul>
      </div>
    </div>
